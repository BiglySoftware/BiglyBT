...
public class AverageNoSync {
  ...
  */
   ...
   */
  protected AverageNoSync(int _refreshRate, int _period) {
   ...
   */
  public static AverageNoSync getInstance(int refreshRate, int period) {
    if (refreshRate < 100)
      return null;
    if ((period * 1000) < refreshRate)
      return null;
    return new AverageNoSync(refreshRate, period);
  }
