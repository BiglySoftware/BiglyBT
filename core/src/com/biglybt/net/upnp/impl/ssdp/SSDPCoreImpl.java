	...
	implements MCGroupAdapter
{
	...
	private List<Runnable>		timer_queue = new ArrayList<>();
			...
			if ( st != null ){
				...
				*/
				...
				if ( response != null ){
					...
					String host = AddressUtils.getHostAddressForURL( local_address );
					...
					String	data =
						...
						"ST: " + st + NL +
						"EXT:" + NL +
						"Location: http://" + host + ":" + mc_group.getControlPort() + "/" + url + NL +
