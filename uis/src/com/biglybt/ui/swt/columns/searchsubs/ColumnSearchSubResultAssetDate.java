...
public class ColumnSearchSubResultAssetDate
	implements TableColumnExtraInfoListener, TableCellRefreshListener
{
	public static final String COLUMN_ID = "assetdate";
	...
	/** Default Constructor */
	public ColumnSearchSubResultAssetDate(TableColumn column) {
	...
	public void refresh(TableCell cell) {
		...
		if (tc instanceof ColumnDateSizer) {
			...
			((ColumnDateSizer) tc).refresh(cell, result==null?0:result.getAssetDate());
		}
	}
}
