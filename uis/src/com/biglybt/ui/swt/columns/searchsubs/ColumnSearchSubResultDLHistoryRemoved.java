...
public class ColumnSearchSubResultDLHistoryRemoved
	implements TableColumnExtraInfoListener, TableCellRefreshListener
{
	public static final String COLUMN_ID = "dlhistoryremoved";
	...
	/** Default Constructor */
	public ColumnSearchSubResultDLHistoryRemoved(TableColumn column) {
	...
	public void refresh(TableCell cell) {
		...
		if (tc instanceof ColumnDateSizer) {
			SearchSubsResultBase result = (SearchSubsResultBase) cell.getDataSource();
			 ...
			 long date = dates==null?0:dates[2];
