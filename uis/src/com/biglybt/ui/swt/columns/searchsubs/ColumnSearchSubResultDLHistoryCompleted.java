...
public class ColumnSearchSubResultDLHistoryCompleted
	implements TableColumnExtraInfoListener, TableCellRefreshListener
{
	public static final String COLUMN_ID = "dlhistorycompleted";
	...
	/** Default Constructor */
	public ColumnSearchSubResultDLHistoryCompleted(TableColumn column) {
	...
	public void refresh(TableCell cell) {
		...
		if (tc instanceof ColumnDateSizer) {
			SearchSubsResultBase result = (SearchSubsResultBase) cell.getDataSource();
			 ...
			 long date = dates==null?0:dates[1];
