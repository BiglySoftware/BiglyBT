...
public class TorrentHashV2Item
extends CoreTableColumnSWT
implements TableCellRefreshListener, ObfuscateCellText
{
	public static final Class DATASOURCE_TYPE = Download.class;

	public static final String COLUMN_ID = "torrenthashv2";
		...
		TableCell cell) 
	{
		...
		try{
			if ( torrent == null || torrent.getTorrentType() == TOTorrent.TT_V1 ){
				
				cell.setText( "" );
				
			}else{
				
				cell.setText( ByteFormatter.encodeString( torrent.getFullHash( TOTorrent.TT_V2 )));
			}
